...
****************************************************************/
/*
Will be using the hardware serial for communicating with the BLE Mate 2 (Digital pins 0,1)
and software serial for communicating with the PC.  
Will not be using the SparkFun SmartBasic Board
*/
