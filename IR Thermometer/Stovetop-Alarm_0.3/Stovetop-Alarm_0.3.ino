 /*************************************************** 
  ...
  This version works with the single zone sensor - need to update to work with dual zone sensor
...
*/
  ...
  // Stuff below here always happens, regardless of temps
/*  
